...
- No clarification markers needed — the user-provided description was comprehensive
- Reasonable defaults applied for standard Kubernetes deployment patterns
